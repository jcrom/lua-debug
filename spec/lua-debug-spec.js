...
import LuaDebug from '../lib/lua-debug';
  ...
  describe('when the lua-debug:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let luaDebugElement = workspaceElement.querySelector('.lua-debug');
        expect(luaDebugElement).toExist();

        let luaDebugPanel = atom.workspace.panelForItem(luaDebugElement);
